...
const MobileLinks = () => {
    ...
    return (
        <section onClick={handleClick} className="hidden animate-toggle-btn origin-top z-10 fixed min-h-screen w-full dark:bg-black pt-32 sm:hidden top-24 bg-indigo-400" id="mobile-menu">

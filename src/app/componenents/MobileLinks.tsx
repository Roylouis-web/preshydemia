...
const MobileLinks = () => {
    ...
    return (
        <section className="hidden animate-toggle-btn origin-top z-10 fixed min-h-screen w-full bg-black pt-32 sm:hidden top-32" id="mobile-menu">
            <nav className="flex dark:text-white flex-col items-center text-4xl gap-10 " aria-label="mobile">
